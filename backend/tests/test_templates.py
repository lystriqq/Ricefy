...
class TestAutostart:
    ...
    def test_hyprlock_lock_keybind(self, jinja_env, default_config):
        output = render_hyprland(jinja_env, default_config)  # default = hyprlock
        assert "hyprlock" in output
        assert 'mod .. " + L"' in output

    def test_swaylock_lock_keybind(self, jinja_env, default_config):
